...
const DOCUMENTS: Record<DocumentType, Document> = {
  terms: {
    ...
    sections: [
      ...
      { title: '3. Eligibility and Account Security', paragraphs: ['You must provide accurate account information and keep your credentials confidential. Do not use VokiToki if you are below the minimum age required by the laws that apply to you.'] },
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '10. Children and Changes', paragraphs: ['VokiToki is not intended for users below the minimum age required by applicable law. We may update this Policy and will update the date above.'] },
    ],
  },
  moderation: {
    title: 'Moderation Policy', updated: 'Last updated: July 20, 2026', icon: 'flag', tint: '#f59e0b',
    sections: [
      ...
      { title: '3. Reasons and Appeals', paragraphs: ['Where appropriate, we will tell an affected user what action was taken and why. As a personal project without a dedicated support channel today, appeals cannot currently be requested by email; this policy will be updated if a contact channel is added.'] },
